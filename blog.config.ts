...
const basicConfig = {
	title: '墨韵云阁',
	subtitle: '记录零散思路与技术点滴，在代码与日常间缓慢积累。偶作深思，闲时随笔，只为给此刻留下一点痕迹🪵',
	// 长 description 利好于 SEO
	description: '记录零散思路与技术点滴，在代码与日常间缓慢积累。偶作深思，闲时随笔，只为给此刻留下一点痕迹🪵。“折腾不止，摸鱼生活——摸门🙏🏻”。',
	author: {
		name: '墨韵云阁',
...
const blogConfig = {
	...
	article: {
		categories: {
			...
			开发笔记: { icon: 'ph:code-bold', color: '#77f' },
		},
